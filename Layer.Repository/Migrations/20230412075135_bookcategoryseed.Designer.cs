...
namespace Layer.Repository.Migrations
{
    ...
    [Migration("20230412075135_bookcategoryseed")]
    partial class bookcategoryseed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Layer.Core.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookID = 15,
                            BookName = "Jules Caesar",
                            Image = "julescaesar.jpg",
                            Pages = (short)132,
                            Price = 25m,
                            Summary = "Jules Caesar",
                            WriterID = 2
                        });
                });

            modelBuilder.Entity("Layer.Core.Entities.Book_Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Layer.Core.Entities.Cart", b =>
                {
            ...
            modelBuilder.Entity("Layer.Core.Entities.Category", b =>
                {
                    b.Property<int>("CategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Layer.Core.Entities.Comment", b =>
                {
            ...
            modelBuilder.Entity("Layer.Core.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("Layer.Core.Entities.InvoiceDetail", b =>
                {
            ...
            modelBuilder.Entity("Layer.Core.Entities.Writer", b =>
                {
                    b.Property<int>("WriterID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Layer.Core.Entities.Book_Category", b =>
                {
                    b.HasOne("Layer.Core.Entities.Book", "Book")
                        .WithMany("Book_Categories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Layer.Core.Entities.Category", "Category")
                        .WithMany("Book_Categories")
            ...
            modelBuilder.Entity("Layer.Core.Entities.InvoiceDetail", b =>
                {
                    ...
                    b.HasOne("Layer.Core.Entities.Invoice", "Invoice")
                        .WithMany("InvoiceDetails")
